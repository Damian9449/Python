...
#print("Dodawanie: ", add_poly([5, 1, 2, 3], [2, 1]))
#print("Odejmowanie: ", sub_poly([5, 1, 2, 3], [2, 1]))
#print("Is zero: ", is_zero([5, 1, 2, 3]))

#print("Cmpy poly: ", cmp_poly([5, 1, 2, 3], [2, 1]))
#print("mul poly: ", mul_poly([5, 1, 2, 3], [2, 1]))
#print("Horner: ", eval_poly([5, 1, 2, 3], 2))

#print("Diff: ", diff_poly([5, 1, 2, 3]))
#print("Pow_poly: ", pow_poly([5, 1, 2, 3], 3))
#print("Combine_poly: ", combine_poly([5, 1, 2, 3], [2, 1]))
